...
const Landing = () => {
    return (
        <div>
            <Navbar/>
            <main
                className="w-full pt-16 md:pt-0 md:h-screen min-h-screen overflow-clip md:bg-gradient-to-r bg-gradient-to-b from-anti-flash-white to-paynes-gray-800">
                <section className="w-full h-full flex md:flex-row flex-col-reverse">
                    <section className="w-full flex flex-col gap-2 justify-center md:px-32 px-10 py-8">
                        ...
                        <p className="py-4 text-base text-paynes-gray-400">Schedule and manage your meetings
                            effortlessly. Combine all your meetings from different platforms into one central hub.</p>
                    </section>
